...
import { AlignLeft, Braces, Check, Copy, Hash, List, X } from "lucide-react"
import {
  type FC,
  useCallback,
  useEffect,
...
const CellDialog: FC<CellDialogProps> = ({ columnName, value, onClose }) => {
